...
namespace app_api.Migrations
{
    ...
    [Migration("20260922171820_IdempotencyOperationMadeEnum")]
    partial class IdempotencyOperationMadeEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdempotencyRecord", b =>
                {
                    ...
                    b.HasIndex("UserId", "Operation", "ClientKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("IdempotencyRecord", b =>
                {
                    b.HasOne("app_api.Models.User", "Originator")
            ...
            modelBuilder.Entity("RefreshToken", b =>
                {
                    b.HasOne("app_api.Models.User", "TokenUser")
